...
export const SCORING_STYLE_PRESETS: ScoringStylePreset[] = [
  {
    id: "value",
    label: "Value",
    blurb: "Optimizes for stocks trading below DCF fair value with solid, safe fundamentals.",
    composite: { intrinsicValue: 45, fundamental: 35, technical: 0, sentiment: 0, analyst: 20 },
    fundamental: { valuation: 55, profitability: 20, growth: 0, financial: 20, dividend: 5 },
  },
  {
    id: "deep-value",
    label: "Deep Value / Contrarian",
    blurb: "Maximizes cheapness vs. intrinsic value for distressed or contrarian turnarounds.",
    composite: { intrinsicValue: 55, fundamental: 30, technical: 0, sentiment: 0, analyst: 15 },
    fundamental: { valuation: 65, profitability: 15, growth: 0, financial: 20, dividend: 0 },
  },
  {
    id: "quality",
    label: "Quality (GARP)",
    blurb: "Optimizes for durable profitability and growth at a still-reasonable price.",
    composite: { intrinsicValue: 15, fundamental: 55, technical: 5, sentiment: 5, analyst: 20 },
    fundamental: { valuation: 10, profitability: 60, growth: 20, financial: 10, dividend: 0 },
  },
  {
    id: "growth",
    label: "Growth",
    blurb: "Optimizes for accelerating revenue and earnings — the business compounding, not the price chart.",
    composite: { intrinsicValue: 0, fundamental: 55, technical: 10, sentiment: 15, analyst: 20 },
    fundamental: { valuation: 0, profitability: 15, growth: 70, financial: 15, dividend: 0 },
  },
  {
    id: "momentum",
    label: "Momentum",
    blurb: "Optimizes for price trend and volume strength; fundamentals barely count.",
    composite: { intrinsicValue: 0, fundamental: 5, technical: 60, sentiment: 25, analyst: 10 },
  },
  {
    id: "sentiment",
    label: "Sentiment / News-driven",
    blurb: "Optimizes for positive news-sentiment flow above all other signals.",
    composite: { intrinsicValue: 0, fundamental: 10, technical: 15, sentiment: 60, analyst: 15 },
  },
  {
    id: "analyst",
    label: "Analyst Consensus",
    blurb: "Optimizes for Wall-Street consensus buy ratings, corroborated by news flow.",
    composite: { intrinsicValue: 5, fundamental: 15, technical: 5, sentiment: 15, analyst: 60 },
  },
  {
    id: "income",
    label: "Dividend / Income",
    blurb: "Optimizes for dividend strength and payout safety over price appreciation.",
    composite: { intrinsicValue: 15, fundamental: 40, technical: 0, sentiment: 5, analyst: 40 },
    fundamental: { valuation: 10, profitability: 20, growth: 0, financial: 15, dividend: 55 },
  },
  {
    id: "balanced",
    label: "Balanced",
    blurb: "The house-default weighting — an even, all-signals starting point.",
